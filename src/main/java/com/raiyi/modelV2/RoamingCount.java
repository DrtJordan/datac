...
public class RoamingCount extends org.apache.avro.specific.SpecificRecordBase implements org.apache.avro.specific.SpecificRecord {
    public static final org.apache.avro.Schema SCHEMA$ = new org.apache.avro.Schema.Parser().parse("{\"type\":\"record\",\"name\":\"RoamingCount\",\"namespace\":\"com.raiyi.modelV2\",\"fields\":[{\"name\":\"not_roaming_count\",\"type\":\"int\",\"doc\":\"��������������\",\"default\":-1},{\"name\":\"in_province_roaming_count\",\"type\":\"int\",\"doc\":\"ʡ��������������\",\"default\":-1},{\"name\":\"inter_province_roaming_count\",\"type\":\"int\",\"doc\":\"ʡ��������������\",\"default\":-1},{\"name\":\"international_roaming_count\",\"type\":\"int\",\"doc\":\"����������������\",\"default\":-1}]}");
    ...
    /** �������������� */
    @Deprecated
    public int not_roaming_count;
    /** ʡ�������������� */
    @Deprecated
    public int in_province_roaming_count;
    /** ʡ�������������� */
    @Deprecated
    public int inter_province_roaming_count;
    /** ���������������� */
    @Deprecated
    public int international_roaming_count;
    ...
    public void put(int field$, java.lang.Object value$) {
        switch (field$) {
            case 0:
                not_roaming_count = (java.lang.Integer) value$;
                break;
            case 1:
                in_province_roaming_count = (java.lang.Integer) value$;
                break;
            case 2:
                inter_province_roaming_count = (java.lang.Integer) value$;
                break;
            case 3:
                international_roaming_count = (java.lang.Integer) value$;
                break;
            default:
                throw new org.apache.avro.AvroRuntimeException("Bad index");
        }
    ...
    public static com.raiyi.modelV2.RoamingCount.Builder newBuilder() {
        return new com.raiyi.modelV2.RoamingCount.Builder();
    }

    /** Creates a new RoamingCount RecordBuilder by copying an existing Builder */
    public static com.raiyi.modelV2.RoamingCount.Builder newBuilder(com.raiyi.modelV2.RoamingCount.Builder other) {
        return new com.raiyi.modelV2.RoamingCount.Builder(other);
    }

    /** Creates a new RoamingCount RecordBuilder by copying an existing RoamingCount instance */
    public static com.raiyi.modelV2.RoamingCount.Builder newBuilder(com.raiyi.modelV2.RoamingCount other) {
        return new com.raiyi.modelV2.RoamingCount.Builder(other);
    }
    ...
    public static class Builder extends org.apache.avro.specific.SpecificRecordBuilderBase<RoamingCount>
        ...
        private Builder() {
            super(com.raiyi.modelV2.RoamingCount.SCHEMA$);
        }

        /** Creates a Builder by copying an existing Builder */
        private Builder(com.raiyi.modelV2.RoamingCount.Builder other) {
            super(other);
        }

        /** Creates a Builder by copying an existing RoamingCount instance */
        private Builder(com.raiyi.modelV2.RoamingCount other) {
            super(com.raiyi.modelV2.RoamingCount.SCHEMA$);
        ...
        /** Sets the value of the 'not_roaming_count' field */
        public com.raiyi.modelV2.RoamingCount.Builder setNotRoamingCount(int value) {
        ...
        public com.raiyi.modelV2.RoamingCount.Builder clearNotRoamingCount() {
        ...
        /** Sets the value of the 'in_province_roaming_count' field */
        public com.raiyi.modelV2.RoamingCount.Builder setInProvinceRoamingCount(int value) {
        ...
        public com.raiyi.modelV2.RoamingCount.Builder clearInProvinceRoamingCount() {
        ...
        /** Sets the value of the 'inter_province_roaming_count' field */
        public com.raiyi.modelV2.RoamingCount.Builder setInterProvinceRoamingCount(int value) {
        ...
        public com.raiyi.modelV2.RoamingCount.Builder clearInterProvinceRoamingCount() {
        ...
        /** Sets the value of the 'international_roaming_count' field */
        public com.raiyi.modelV2.RoamingCount.Builder setInternationalRoamingCount(int value) {
        ...
        public com.raiyi.modelV2.RoamingCount.Builder clearInternationalRoamingCount() {
