...
public class HostPair extends org.apache.avro.specific.SpecificRecordBase implements org.apache.avro.specific.SpecificRecord {
  public static final org.apache.avro.Schema SCHEMA$ = new org.apache.avro.Schema.Parser().parse("{\"type\":\"record\",\"name\":\"HostPair\",\"namespace\":\"com.raiyi.dpiModel\",\"fields\":[{\"name\":\"host\",\"type\":\"string\"},{\"name\":\"frequency\",\"type\":\"int\"}]}");
  ...
  public static com.raiyi.dpiModel.HostPair.Builder newBuilder() {
    return new com.raiyi.dpiModel.HostPair.Builder();
  }
  
  /** Creates a new HostPair RecordBuilder by copying an existing Builder */
  public static com.raiyi.dpiModel.HostPair.Builder newBuilder(com.raiyi.dpiModel.HostPair.Builder other) {
    return new com.raiyi.dpiModel.HostPair.Builder(other);
  }
  
  /** Creates a new HostPair RecordBuilder by copying an existing HostPair instance */
  public static com.raiyi.dpiModel.HostPair.Builder newBuilder(com.raiyi.dpiModel.HostPair other) {
    return new com.raiyi.dpiModel.HostPair.Builder(other);
  }
  ...
  public static class Builder extends org.apache.avro.specific.SpecificRecordBuilderBase<HostPair>
    ...
    private Builder() {
      super(com.raiyi.dpiModel.HostPair.SCHEMA$);
    }
    
    /** Creates a Builder by copying an existing Builder */
    private Builder(com.raiyi.dpiModel.HostPair.Builder other) {
      super(other);
    }
    
    /** Creates a Builder by copying an existing HostPair instance */
    private Builder(com.raiyi.dpiModel.HostPair other) {
            super(com.raiyi.dpiModel.HostPair.SCHEMA$);
    ...
    /** Sets the value of the 'host' field */
    public com.raiyi.dpiModel.HostPair.Builder setHost(java.lang.CharSequence value) {
    ...
    public com.raiyi.dpiModel.HostPair.Builder clearHost() {
      host = null;
    ...
    /** Sets the value of the 'frequency' field */
    public com.raiyi.dpiModel.HostPair.Builder setFrequency(int value) {
    ...
    public com.raiyi.dpiModel.HostPair.Builder clearFrequency() {
