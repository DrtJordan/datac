...
public class RoamingFlow extends org.apache.avro.specific.SpecificRecordBase implements org.apache.avro.specific.SpecificRecord {
    ...
    /** ���������� */
    @Deprecated
    public int not_roaming_flow;
    /** ʡ���������� */
    @Deprecated
    public int in_province_roaming_flow;
    /** ʡ���������� */
    @Deprecated
    public int inter_province_roaming_flow;
    /** ������������ */
    @Deprecated
    public int international_roaming_flow;
    ...
    public void put(int field$, java.lang.Object value$) {
        switch (field$) {
            case 0:
                not_roaming_flow = (java.lang.Integer) value$;
                break;
            case 1:
                in_province_roaming_flow = (java.lang.Integer) value$;
                break;
            case 2:
                inter_province_roaming_flow = (java.lang.Integer) value$;
                break;
            case 3:
                international_roaming_flow = (java.lang.Integer) value$;
                break;
            default:
                throw new org.apache.avro.AvroRuntimeException("Bad index");
        }
