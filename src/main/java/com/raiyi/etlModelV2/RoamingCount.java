...
public class RoamingCount extends org.apache.avro.specific.SpecificRecordBase implements org.apache.avro.specific.SpecificRecord {
  ...
  public static com.raiyi.etlModelV2.RoamingCount.Builder newBuilder() {
    return new com.raiyi.etlModelV2.RoamingCount.Builder();
  }
  
  /** Creates a new RoamingCount RecordBuilder by copying an existing Builder */
  public static com.raiyi.etlModelV2.RoamingCount.Builder newBuilder(com.raiyi.etlModelV2.RoamingCount.Builder other) {
    return new com.raiyi.etlModelV2.RoamingCount.Builder(other);
  }
  
  /** Creates a new RoamingCount RecordBuilder by copying an existing RoamingCount instance */
  public static com.raiyi.etlModelV2.RoamingCount.Builder newBuilder(com.raiyi.etlModelV2.RoamingCount other) {
    return new com.raiyi.etlModelV2.RoamingCount.Builder(other);
  }
  ...
  public static class Builder extends org.apache.avro.specific.SpecificRecordBuilderBase<RoamingCount>
    ...
    private Builder() {
      super(com.raiyi.etlModelV2.RoamingCount.SCHEMA$);
    }
    
    /** Creates a Builder by copying an existing Builder */
    private Builder(com.raiyi.etlModelV2.RoamingCount.Builder other) {
      super(other);
    }
    
    /** Creates a Builder by copying an existing RoamingCount instance */
    private Builder(com.raiyi.etlModelV2.RoamingCount other) {
            super(com.raiyi.etlModelV2.RoamingCount.SCHEMA$);
    ...
    /** Sets the value of the 'not_roaming_count' field */
    public com.raiyi.etlModelV2.RoamingCount.Builder setNotRoamingCount(int value) {
    ...
    public com.raiyi.etlModelV2.RoamingCount.Builder clearNotRoamingCount() {
    ...
    /** Sets the value of the 'in_province_roaming_count' field */
    public com.raiyi.etlModelV2.RoamingCount.Builder setInProvinceRoamingCount(int value) {
    ...
    public com.raiyi.etlModelV2.RoamingCount.Builder clearInProvinceRoamingCount() {
    ...
    /** Sets the value of the 'inter_province_roaming_count' field */
    public com.raiyi.etlModelV2.RoamingCount.Builder setInterProvinceRoamingCount(int value) {
    ...
    public com.raiyi.etlModelV2.RoamingCount.Builder clearInterProvinceRoamingCount() {
    ...
    /** Sets the value of the 'international_roaming_count' field */
    public com.raiyi.etlModelV2.RoamingCount.Builder setInternationalRoamingCount(int value) {
    ...
    public com.raiyi.etlModelV2.RoamingCount.Builder clearInternationalRoamingCount() {
