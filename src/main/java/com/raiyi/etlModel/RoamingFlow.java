...
public class RoamingFlow extends org.apache.avro.specific.SpecificRecordBase implements org.apache.avro.specific.SpecificRecord {
  ...
  public static com.raiyi.etlModel.RoamingFlow.Builder newBuilder() {
    return new com.raiyi.etlModel.RoamingFlow.Builder();
  }
  
  /** Creates a new RoamingFlow RecordBuilder by copying an existing Builder */
  public static com.raiyi.etlModel.RoamingFlow.Builder newBuilder(com.raiyi.etlModel.RoamingFlow.Builder other) {
    return new com.raiyi.etlModel.RoamingFlow.Builder(other);
  }
  
  /** Creates a new RoamingFlow RecordBuilder by copying an existing RoamingFlow instance */
  public static com.raiyi.etlModel.RoamingFlow.Builder newBuilder(com.raiyi.etlModel.RoamingFlow other) {
    return new com.raiyi.etlModel.RoamingFlow.Builder(other);
  }
  ...
  public static class Builder extends org.apache.avro.specific.SpecificRecordBuilderBase<RoamingFlow>
    ...
    private Builder() {
      super(com.raiyi.etlModel.RoamingFlow.SCHEMA$);
    }
    
    /** Creates a Builder by copying an existing Builder */
    private Builder(com.raiyi.etlModel.RoamingFlow.Builder other) {
      super(other);
    }
    
    /** Creates a Builder by copying an existing RoamingFlow instance */
    private Builder(com.raiyi.etlModel.RoamingFlow other) {
            super(com.raiyi.etlModel.RoamingFlow.SCHEMA$);
    ...
    /** Sets the value of the 'not_roaming_flow' field */
    public com.raiyi.etlModel.RoamingFlow.Builder setNotRoamingFlow(int value) {
    ...
    public com.raiyi.etlModel.RoamingFlow.Builder clearNotRoamingFlow() {
    ...
    /** Sets the value of the 'in_province_roaming_flow' field */
    public com.raiyi.etlModel.RoamingFlow.Builder setInProvinceRoamingFlow(int value) {
    ...
    public com.raiyi.etlModel.RoamingFlow.Builder clearInProvinceRoamingFlow() {
    ...
    /** Sets the value of the 'inter_province_roaming_flow' field */
    public com.raiyi.etlModel.RoamingFlow.Builder setInterProvinceRoamingFlow(int value) {
    ...
    public com.raiyi.etlModel.RoamingFlow.Builder clearInterProvinceRoamingFlow() {
    ...
    /** Sets the value of the 'international_roaming_flow' field */
    public com.raiyi.etlModel.RoamingFlow.Builder setInternationalRoamingFlow(int value) {
    ...
    public com.raiyi.etlModel.RoamingFlow.Builder clearInternationalRoamingFlow() {
